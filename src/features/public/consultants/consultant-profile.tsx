              ...
              <Card>
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--surface-muted))] p-4 text-sm text-[rgb(var(--text-muted))]">
                    Консультант фиксирует запрос, делает анализ по системе и затем выдаёт рекомендации, активации и follow-up.
                  </div>
                  <div className="rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--surface-muted))] p-4 text-sm text-[rgb(var(--text-muted))]">
                    Доступна история взаимодействий и структурированные заметки клиента.
                  </div>
                </CardContent>
              </Card>
            </div>
